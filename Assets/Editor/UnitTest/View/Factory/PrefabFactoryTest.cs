...
namespace Assets.Editor.UnitTest.View.Factory
{
    ...
    {
        [Test]
        public static void SetPrefabTest_親無し()
        {
            var name1 = $"{nameof(MonoBehaviourMock)}_{nameof(SetPrefabTest_親無し)}";
            var object1 = name1.SetPrefab<MonoBehaviourMock>();
        ...
        [Test]
        public static void SetPrefabTest_親指定_名称指定()
        {
            var view = new GameObject(nameof(SetPrefabTest_親指定_名称指定), typeof(ViewState)).GetComponent<ViewState>();

            var name1 = $"{nameof(MonoBehaviourMock)}_{nameof(SetPrefabTest_親指定_名称指定)}";
        ...
        [Test]
        public static void SetPrefabTest_親指定_名称自動()
        {
            var view = new GameObject(nameof(SetPrefabTest_親指定_名称自動), typeof(ViewState)).GetComponent<ViewState>();
